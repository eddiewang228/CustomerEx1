namespace CustomerEx1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶關聯清單Repository Get客戶關聯清單Repository()
		{
			var repository = new 客戶關聯清單Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶關聯清單Repository Get客戶關聯清單Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶關聯清單Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
